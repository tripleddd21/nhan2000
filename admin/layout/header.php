            ...
            <div class="navbar-header">
                <a href="admin.php" class="navbar-brand">
                    <div class="brand-image brand-big">
                        <img src="admin/assets/img/logo-big-momatrip .png" alt="logo" class="logo-big">
                    </div>
                    <div class="brand-image brand-small">
                        <img src="admin/assets/img/logo-header.png" alt="logo" class="logo-small">
                    </div>
                </a>
                <!-- Toggle Button -->
                ...
                <li class="nav-item dropdown"><a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><img src="admin/assets/img/logo-header.png" alt="..." class="avatar rounded-circle"></a>
                    <ul aria-labelledby="user" class="user-size dropdown-menu">
                        <li class="welcome">
                            ...
                            <img src="admin/assets/img/logo-big-momatrip .png" alt="..." class="rounded-circle">
                        </li>
                        <li>
